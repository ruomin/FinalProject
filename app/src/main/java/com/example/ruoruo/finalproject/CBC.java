...
public class CBC extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch (id){
            case R.id.cbc_item: intent = new Intent(this, CBC.class);
            ...
            case R.id.cbc_item_help:
                builder = new AlertDialog.Builder(CBC.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Snackbar.make(v,"Are you sure your want to search?", Snackbar.LENGTH_LONG).setAction("Confirm", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(CBC.this, CBC_frame.class);
                        startActivity(intent);
        ...
        asyButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CBC.this, CBCDetail.class);
                startActivity(intent);
                Log.i(ACTIVITY_NAME, "In onClick()");
            }
        });
