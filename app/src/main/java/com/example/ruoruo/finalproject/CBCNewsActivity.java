...
public class CBCNewsActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch (id){
            ...
            case R.id.cbc_n_item: intent = new Intent(this, NutritionActivity.class);
                startActivity(intent);
                break;
            case R.id.cbc_movie_item: intent = new Intent(this, MovieActivity.class);
                startActivity(intent);
                break;
            case R.id.cbc_oc_item: intent = new Intent(this, OCTranspoActivity.class);
                startActivity(intent);
                break;
